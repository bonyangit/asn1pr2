...
public class Asn1Dump {
    ...
    //public static = new ArrayList<String>();
    static String dumpAsString(String inpvar, DERObject derobj, String tagno, String value, AsnTags AsnTags,HashMap<String, String> output,List<String> seqoutput ) {
        ...
        if (!(derobj instanceof ASN1Sequence)) {
            if (derobj instanceof DERTaggedObject) {
                ...
                if (derobj instanceof DEROctetString) {
                    if (condition == "2") {
                        ...
                        var9 = (ASN1OctetString) derobj;
                        //return inpvar + dumpBinaryDataAsString(inpvar, var9.getOctets()) + seprator;
                        output.put(lasttagno, dumpBinaryDataAsString(inpvar, var9.getOctets(), lasttagno));
                        return inpvar + dumpBinaryDataAsString(inpvar, var9.getOctets(), lasttagno) + "/";
            ...
            while (true) {
                ...
                return AsnTags.builder(output, seqoutput);
                //return stringbfr.toString();
            }
        }
        return seprator;
